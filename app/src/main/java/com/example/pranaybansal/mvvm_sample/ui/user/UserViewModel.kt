...
class UserViewModel @Inject constructor(val repository: UserRepository, application: Application, compositeDisposable: CompositeDisposable) : BaseViewModel(application,compositeDisposable) {
